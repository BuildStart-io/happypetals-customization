...
INSERT INTO happypetal_customization.platform_settings (key, value)
VALUES (
  'plan_limits',
  '{
...
-- ----------------------------------------------------------------------------
-- INSERT INTO happypetal_customization.profiles (user_id, email, full_name, plan_tier, billing_cycle_start)
